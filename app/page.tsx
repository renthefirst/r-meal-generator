...
export default function HomePage() {
  return (
    <div className="px-12 py-16 sm:py-12 lg:py-16 max-w-7xl mx-auto">
      <section className="bg-gradient-to-r from-emerald-400 to-emerald-600 text-white rounded-xl mb-12 p-6 mt-10 text-center">
