        ...
        {availablePlans.map((plan, key) => (
          ...
          >
            ...
            <button
              ...
              }  mt-8 block w-full py-3 px-6 border border-transparent rounded-md text-center font-medium disabled:bg-gray-400 disabled:cursor-not-allowed duration-300`}
